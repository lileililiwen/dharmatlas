...
## Purpose
Provide truthful time, place, and connection exploration through real map, timeline, and graph rendering with accessible equivalents, without inventing precision or depending on a single tile vendor.
