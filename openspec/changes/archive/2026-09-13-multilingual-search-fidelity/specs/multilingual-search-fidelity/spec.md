...
## Purpose
Resolve equivalent Buddhist names across scripts and romanizations to one canonical entity with transparent match display, backed by a benchmarked PostgreSQL implementation.
